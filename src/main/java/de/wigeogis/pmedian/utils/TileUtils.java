...
public class TileUtils {
  ...
  public String envelopeToBoundsSQL(HashMap<String, Double> env) {
    ...
    return String.format("ST_Segmentize(ST_MakeEnvelope(%f, %f, %f, %f, 3857), %f)",
  ...
  public String envelopeToSQL(HashMap<String, Object> tbl, HashMap<String, Double> env) {
    ...
    String sql_tmpl = """
        ...
        """;
    return String.format(sql_tmpl, tbl.get("env"), tbl.get("env"), tbl.get("geomColumn"),
        tbl.get("attrColumns"), tbl.get("table"), tbl.get("geomColumn"), tbl.get("srid"));
  }
